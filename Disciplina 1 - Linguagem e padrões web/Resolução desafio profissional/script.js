//Variavel que busca o elemento do "visor" - input readonly do HTML
...
//Ao carregar a página, atribui eventos aos botões pelos ids
...
function inserirNumero(){
    ...
    if (isNaN(inputResultado.value)) {
        ...
        if (inputResultado.value == 0) { 
            inputResultado.value = event.target.textContent;
        //Senão adiciona o número aos digitos no valor
        } else { 
            inputResultado.value += event.target.textContent;
        }
    }
...
function dividir(valor1, valor2){
    if(valor2 === 0){
        return "Erro, não é possivel dividir um número por 0!";
    }else {
        return valor1 / valor2;
    }
}

//Limpa o visor e os dados do calculo
